...
*/
const XPTN = 'DIL-BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/fadil_vg78'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+62 853-4378-8098'; // Nomor whatsapplu cok
const aktif = 'Tergantung bapaklo'; // Kapan bot lu aktif
//
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:XP Ganss\n' // full name
            + 'ORG:Owner DIL-BOT Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid+62 853-4378-8098=:+62 853-4378-8098\n' // WhatsApp ID + phone number
            + 'END:VCARD'
//
const
{
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/+62 853-4378-8098* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
...
if (text.includes('.urltoimg')){
  var teks = text.replace(/.urltoimg /, '')
    axios.get(`https://mhankbarbar.herokuapp.com/api/url2image?url=${teks}&apiKey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
  ...
  var teks = text.replace(/.randomkis /, '')
    ...
    .then((res) => {
      imagegifToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[ WAIT ] Sedang di proses⏳ silahkan tunggu sebentar tod', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
    ...
    axios.get(`https://terhambar.com/aw/qts/?kata=${quote}&author=${wm}&tipe=${bg}`).then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, '[ WAIT ] Sedang diproses⏳ silahkan tunggu sebentar tod', MessageType.text, { quoted: m })
...
if (text.includes('.nulis2')){
  var teks = text.replace(/%nulis2 /, '')
    axios.get(`https://mhankbarbars.herokuapp.com/nulis?text=${teks}&apiKey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
...
axios.get(`https://mhankbarbar.herokuapp.com/api/nekopoi?url=${teks}&apikey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
...
const animes =  axios.get(`https://mhankbarbar.herokuapp.com/api/otakudesu?q=${teks}&apiKey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...❗', MessageType.text)
...
const gtts = (`https://rest.farzain.com/api/tts.php?id=${teks}&apikey=B4w56Fy3WQnfEyUNvQy8`)
...
conn.sendMessage(id, xp.xp(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools1'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp1.xp1(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools2'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp2.xp2(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools3'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp3.xp3(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools4'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp4.xp4(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools5'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp5.xp5(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools6'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, xp6.xp6(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.sellernomor'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, sellernomor.sellernomor(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.donasii'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donasii.donasii(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, DIL-BOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.foto'){
conn.sendMessage(id, 'kirim .foto cewek/cowok\n\nContoh: .foto cewek' ,MessageType.text);
}
else if (text == '.help'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾DIL-BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@fadil_vg78' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾DIL-BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@fadil_vg78' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾DIL-BOT�ll* , Follow Instagram Mimin Yah😻 : https://instagram.com/@fadil_vg78' ,MessageType.text);
}
...
axios.get(`https://mhankbarbars.herokuapp.com/api/cuaca?q=${teks}&apiKey=B4w56Fy3WQnfEyUNvQy8`).then((res) => {
